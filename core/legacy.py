...
# Do not import features.upload_admin here. That creates a circular dependency:
# features -> core.legacy -> features. Data admin pages import the feature module directly.
